...
export interface FileDiagnosticStatus {
  name: string;
  path: string;
  exists: boolean;
...
export interface ServerDiagnostics {
  databasePath: string;
  schemaPath: string;
  jsonBackupDirectory: string;
  databaseSizeBytes?: number | null;
  databaseLastWriteUtc?: string | null;
  schemaLastWriteUtc?: string | null;
  appStateUpdatedAtUtc?: string | null;
  tableCounts: Record<string, number>;
  backupFiles: FileDiagnosticStatus[];
  pendingLogEntries: number;
}
